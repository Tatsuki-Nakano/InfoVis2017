function Isosurfaces( volume, iso, screen, materialcolor, opacity )
{
    /*
    // Create color map                                                                                                                                            
    var cmap = [];
    ...
    */
	...
	transparent: true,
	    ...
	    matColor: { type: 'v3', value: materialcolor },
	    matAlpha: { type: 'f', value: opacity }
        }
    });
    
    //var material = new THREE.MeshLambertMaterial( {transparent: true, color: materialcolor, opacity: opacity });
    var smin = volume.min_value;
    var smax = volume.max_value;
    var isovalue = KVS.Clamp( iso, smin, smax );
